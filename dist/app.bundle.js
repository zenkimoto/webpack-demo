...
function component() {
    return __WEBPACK_IMPORTED_MODULE_1_jquery___default()("<div/>").html(__WEBPACK_IMPORTED_MODULE_0_lodash___default.a.join(['Hello', 'webpack', 'Alex'], ' ')).addClass('red').append(__WEBPACK_IMPORTED_MODULE_1_jquery___default()('<button/>').click(__WEBPACK_IMPORTED_MODULE_2__print_js__["default"]).html('Click Me'));
  }
